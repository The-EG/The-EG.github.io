Knurled Knobs in FreeCAD
========================

:author: Taylor Talkington
:date: 2021-01-14 06:20 -0500
:tags: freecad, 3d-printing

.. warning::

   These instructions still work, but new tools have been introduced into more
   recent versions of FreeCAD (0.19+) that make this *much* easier than how
   it is described here.

.. image:: /assets/knurling.png

Knurly, Dude!
-------------

The 3D Printing adventures continue, and as I find myself designing things I
had the question: how can I make knurled surfaces in FreeCAD?

After some research and combining a few different techniques, here's what I
came up with.

Creating Knurling
-----------------

This technique only works on circular surfaces (cylinders), but that's ok
because most knobs and handles are round anyway...

For this example, I made a knob for my 3D Printer's LCD encoder in FreeCAD
version 0.19. Actions specified are in the 'Task' pane.

First, create a simple knob:

.. |trim tool| image:: /assets/knurling_9.png


1. Select Part Design Workbench
2. Create Body
3. Create Sketch (select XY_Plane)
4. Add a circle with a radius of 10 mm, snapped to the center origin  
   .. image:: /assets/knurling_1.png
5. Close the sketch
6. Pad it by 10 mm  
   
   .. image:: /assets/knurling_2.png

7. Select the top edge  
   
   .. image:: /assets/knurling_3.png

8. Fillet 2 mm  
   
   .. image:: /assets/knurling_4.png

9. Select the bottom face
10. Create Sketch
11. Add a circle with a radius of 7 mm, anchored to the origin  
    
    .. image:: /assets/knurling_5.png

12. Pocket 9 mm
13. Select the new inner face  
    
    .. image:: /assets/knurling_6.png
...
16. Add 2 vertical lines near the top of the circles, connecting them
    ...
    .. image:: /assets/knurling_8.png

17. Use the Trim Edge tool to remove the portion of the circles between the lines: |trim tool|
    
    .. image:: /assets/knurling_10.png
...
9. Draw a triangle near the base of the helix:
   ...
   4. Constrain that point to be 9 mm from the y axis
   5. Constrain one of the other points to be 10.5 mm from the y axis
   6. Constrain the far edge to be vertical
   7. Close sketch
  
   .. image:: /assets/knurling_12.png
...
17. Cut the helixes from the knob
    ...
    .. image:: /assets/knurling_16.png

There! A knurled knob. I didn't quite like it yet, though. But, tweaking it is
easy since FreeCAD is parametric.
